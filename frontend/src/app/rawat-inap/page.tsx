    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="mt-16 md:mt-24">
            <div className="text-center mb-8 md:mb-12">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-100 to-indigo-100 px-4 md:px-6 py-2 md:py-3 rounded-full mb-4 md:mb-6">
                <UserCheck className="w-4 h-4 md:w-5 md:h-5 text-blue-600" />
                <span className="text-blue-700 font-bold text-xs md:text-sm tracking-wide">PANDUAN PENDAFTARAN</span>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              <div className="group relative bg-white rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-teal-200 transform hover:-translate-y-2">
                <div className="absolute -top-2 md:-top-4 left-4 md:left-8">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xs md:text-sm">
                    1
                  </div>
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-teal-50 to-teal-100 text-teal-600 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <UserCheck className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2 md:mb-3 text-sm md:text-lg">Pendaftaran</h4>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">Daftar di loket dengan identitas diri, kartu BPJS/asuransi, dan surat rujukan dokter.</p>
              </div>
              
              <div className="group relative bg-white rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2">
                <div className="absolute -top-2 md:-top-4 left-4 md:left-8">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-xs md:text-sm">
                    2
                  </div>
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-blue-600 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Stethoscope className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2 md:mb-3 text-sm md:text-lg">Evaluasi Dokter</h4>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">Penilaian kondisi pasien dan penentuan kebutuhan perawatan yang sesuai.</p>
              </div>
              
              <div className="group relative bg-white rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-indigo-200 transform hover:-translate-y-2">
                <div className="absolute -top-2 md:-top-4 left-4 md:left-8">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full flex items-center justify-center font-bold text-xs md:text-sm">
                    3
                  </div>
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-indigo-50 to-indigo-100 text-indigo-600 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Bed className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2 md:mb-3 text-sm md:text-lg">Pilih Kamar</h4>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">Pemilihan tipe kamar rawat inap sesuai ketersediaan dan preferensi Anda.</p>
              </div>
              
              <div className="group relative bg-white rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-green-200 transform hover:-translate-y-2">
                <div className="absolute -top-2 md:-top-4 left-4 md:left-8">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-full flex items-center justify-center font-bold text-xs md:text-sm">
                    4
                  </div>
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-green-50 to-green-100 text-green-600 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <CheckCircle className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2 md:mb-3 text-sm md:text-lg">Masuk Perawatan</h4>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">Proses administrasi akhir dan pasien siap mendapatkan perawatan medis.</p>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="mt-16 md:mt-24">
            <div className="text-center mb-8 md:mb-12">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-100 to-pink-100 px-4 md:px-6 py-2 md:py-3 rounded-full mb-4 md:mb-6">
                <MessageCircle className="w-4 h-4 md:w-5 md:h-5 text-purple-600" />
                <span className="text-purple-700 font-bold text-xs md:text-sm tracking-wide">FAQ</span>
              </div>
              <h3 className="text-2xl md:text-4xl font-extrabold text-gray-900 mb-3 md:mb-4">
                Pertanyaan yang
            ...
            <div className="max-w-4xl mx-auto space-y-3 md:space-y-4">
              {faqs.map((item, i) => {
                ...
                return (
                  <div key={item.q} className="group bg-white border border-gray-200 rounded-xl md:rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                    <button
                      onClick={() => setOpenFaq(open ? null : i)}
                      className="w-full flex items-center justify-between px-4 md:px-8 py-4 md:py-6 bg-white hover:bg-gradient-to-r hover:from-gray-50 hover:to-white transition-all duration-300"
                      aria-expanded={open}
                    >
                      <span className="text-left font-bold text-gray-900 text-sm md:text-lg group-hover:text-teal-700 transition-colors duration-300">
                        {item.q}
                      </span>
                      <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-r from-teal-500 to-blue-600 flex items-center justify-center transition-all duration-300 ${open ? 'rotate-180 scale-110' : ''}`}>
                        <ChevronDown className="w-4 h-4 md:w-5 md:h-5 text-white" />
                      </div>
                    </button>
                    {open && (
                      <div className="px-4 md:px-8 pb-4 md:pb-6 bg-gradient-to-r from-gray-50 to-white">
                        <div className="p-4 md:p-6 bg-white rounded-lg md:rounded-xl border border-gray-100 shadow-sm">
